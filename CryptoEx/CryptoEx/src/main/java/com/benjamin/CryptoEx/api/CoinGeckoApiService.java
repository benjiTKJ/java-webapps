package com.benjamin.CryptoEx.api;
...
public interface CoinGeckoApiService {
	...
	/*
	 * @GET("coins/{id}/market_chart") Call<MarketChart>
	 * getCoinMarketChartById(@Path("id") String id, @Query("vs_currency") String
	 * vsCurrency,
	 * 
	 ...
	 * 
	 * @GET("coins/{id}/market_chart/range") Call<MarketChart>
	 * getCoinMarketChartRangeById(@Path("id") String id, @Query("vs_currency")
	 * String vsCurrency,
	 * 
	 * @Query("from") String from, @Query("to") String to);
	 * 
	 * @GET("coins/{id}/status_updates") Call<StatusUpdates>
	 * getCoinStatusUpdateById(@Path("id") String id, @Query("per_page") Integer
	 * perPage, @Query("page") Integer page);
	 */
	...
	/*
	 * @GET("asset_platforms") Call<List<AssetPlatforms>> getAssetPlatforms();
	 * 
	 * @GET("exchanges") Call<List<Exchanges>> getExchanges(@Query("per_page") int
	 * perPage, @Query("page") int page);
	 * 
	 * @GET("exchanges/list") Call<List<ExchangesList>> getExchangesList();
	 * 
	 * @GET("exchanges/{id}") Call<ExchangeById> getExchangesById(@Path("id") String
	 * id);
	 * 
	 * @GET("exchanges/{id}/tickers") Call<ExchangesTickersById>
	 * getExchangesTickersById(@Path("id") String id, @Query("coin_ids") String
	 * coinIds,
	 * 
	 * @Query("page") Integer page, @Query("order") String order);
	 * 
	 * @GET("exchanges/{id}/status_updates") Call<StatusUpdates>
	 * getExchangesStatusUpdatesById(@Path("id") String
	 * id, @Query("per_page")Integer perPage,
	 * 
	...
	/*
	 * @GET("status_updates") Call<StatusUpdates> getStatusUpdates();
	 * 
	 * @GET("status_updates") Call<StatusUpdates>
	 * getStatusUpdates(@Query("category") String category, @Query("project_type")
	 * String projectType,
	 * 
	 * @Query("per_page") Integer perPage, @Query("page") Integer page);
	 * 
	 * @GET("events") Call<Events> getEvents();
	 * 
	 * @GET("events") Call<Events> getEvents(@Query("country_code") String
	 * countryCode, @Query("type") String type,
	 * 
	 * @Query("page") Integer page, @Query("upcoming_events_only") boolean
	 * upcomingEventsOnly,
	 * 
	 * @Query("from_date") String fromDate, @Query("to_date") String toDate);
	 * 
	 * @GET("events/countries") Call<EventCountries> getEventsCountries();
	 * 
	 * @GET("events/types") Call<EventTypes> getEventsTypes();
	 * 
	 * @GET("exchange_rates") Call<ExchangeRates> getExchangeRates();
	 * 
	 * @GET("search/trending") Call<Trending> getTrending();
	 * 
	 * @GET("global") Call<Global> getGlobal();
	 * 
	 * @GET("global/decentralized_finance_defi") Call<DecentralizedFinanceDefi>
