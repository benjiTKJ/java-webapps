...
public interface CoinGeckoApiClient {
	...
	/*
	 * MarketChart getCoinMarketChartById(String id, String vsCurrency, Integer
	 * days);
	 * 
	 * MarketChart getCoinMarketChartById(String id, String vsCurrency, Integer
	 * days, String interval);
	 * 
	 * MarketChart getCoinMarketChartRangeById(String id, String vsCurrency, String
	 * from, String to);
	 * 
	 * StatusUpdates getCoinStatusUpdateById(String id);
	 * 
	 * StatusUpdates getCoinStatusUpdateById(String id, Integer perPage, Integer
	 * page);
	 */
	 ...
	 * 
	 * ExchangesTickersById getExchangesTickersById(String id, String coinIds,
	 * Integer page, String order);
	 * 
	 * StatusUpdates getExchangesStatusUpdatesById(String id);
	 * 
	 * StatusUpdates getExchangesStatusUpdatesById(String id, Integer perPage,
	 * Integer page);
	 */
	 ...
	 * 
	 * StatusUpdates getStatusUpdates(String category, String projectType, Integer
	 * perPage, Integer page);
	 * 
	 * Events getEvents();
	 * 
	 * Events getEvents(String countryCode, String type, Integer page, boolean
	 * upcomingEventsOnly, String fromDate, String toDate);
	 * 
