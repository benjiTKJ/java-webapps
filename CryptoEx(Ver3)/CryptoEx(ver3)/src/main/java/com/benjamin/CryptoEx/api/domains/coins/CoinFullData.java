...
import com.benjamin.CryptoEx.api.domains.coins.coinData.CommunityData;
import com.benjamin.CryptoEx.api.domains.coins.coinData.IcoData;
import com.benjamin.CryptoEx.api.domains.coins.coinData.Links;
...
public class CoinFullData {
	...
	/*
	 * Commented out for now as might not be using 
